    ...
    private
      def demo_definitions
        ...
        [
          ...
          {
            workflow_key: "demo_vendor_feed_watch",
            class_name: "#{DEMO_CLASS_PREFIX}VendorFeedWatchJob",
            queue_name: "feeds",
            priority: 10,
            schedule: "*/10 * * * *",
            trigger_key: "feed:vendors",
            trigger_type: "feed",
            seed_scheduled_at: now + 2.days,
            ...
            error: <<~ERROR.strip,
              Faraday::TimeoutError: execution expired while polling vendor feed
              app/lib/r3x/client/http.rb:41:in `get'
              workflows/vendors/feed_watch/workflow.rb:18:in `run'
            ERROR
